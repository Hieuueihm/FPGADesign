...
HD_PWD='D:/Workspace/VHDL/Study/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log half_adder_vhdl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source half_adder_vhdl.tcl
